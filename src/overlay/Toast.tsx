  ...
  return ReactDOM.createPortal(
    <div className = {Style.getStyleClassName(containerStyle)}>
      {toasts.map((t, index) => {
        ...
        if (t.type === 'success') {
          iconStyle.color = '#fff';
          Objector.extender(tStyle, { color: '#fff', backgroundColor: theme.success[theme.mode as Themes] });
          iconColor = '#fff';
          textColor = '#fff';
        ...
        if (t.type === 'error') {
          iconStyle.color = '#fff';
          Objector.extender(tStyle, { color: '#fff', backgroundColor: theme.error[theme.mode as Themes] });
          iconColor = '#fff';
          textColor = '#fff';
        ...
        return (
          ...
          >
            <div className = {Style.getStyleClassName(toastContainerStyle)}>
              ...
              <IconButton style={{ color: iconColor }} icon = {<CloseIcon />} value = 'close' onClick={() => toaster.requestClose(t.id)} />
            </div>
          </Paper>
        );
      })}
