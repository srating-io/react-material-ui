...
export const useTextInputLogic = <T extends HTMLInputElement | HTMLTextAreaElement>(props: TextInputProps | TextareaProps) => {
  ...
  return useBaseInputLogic<string | number, T>({
    ...props,
    validator: textValidator,
    transformOnBlur,
  } as BaseInputProps<string | number, T>);
};
